...
public class ProductCategoryAdapter extends RecyclerView.Adapter<ProductCategoryAdapter.CategoryViewHolder>
{
    ...
    {
        final ProductCategory category = categoryList.get(position);
        ...
        holder.img_category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Utils.loadFragmentWithMultipleData(context , new ProductListFragment() , bundle);
            }
        });
    }
    ...
    public void addNewData(List<ProductCategory> newProductsnew)
    {
        categoryList.addAll(newProductsnew);
        notifyDataSetChanged();
    }

    public void updateData(List<ProductCategory> newProductsnew)
    {
        categoryList.clear();
