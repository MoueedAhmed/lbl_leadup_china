...
public class CouponListAdapter extends RecyclerView.Adapter<CouponListAdapter.CouponViewHolder>
{
    ...
    public CouponListAdapter(Context context, List<Coupons> couponsList)
    {
    ...
    public CouponViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        View view = inflater.inflate(R.layout.card_coupon_list, null);
    ...
    public void addNewData(List<Coupons> newProductsnew)
    {
        couponsList.addAll(newProductsnew);
        notifyDataSetChanged();
    }

    public void updateData(List<Coupons> newProductsnew)
    {
        couponsList.clear();
        couponsList = newProductsnew;
        notifyDataSetChanged();
    }
